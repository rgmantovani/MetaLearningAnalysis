...
SIMPLE = c("classes", "attributes", "numeric", "nominal", "samples", "dimension", "numRate", 
  ...
  "classes_min", "classes_max", "classes_mean", "classes_sd")

STATISTICS = c("sks", "sksP", "kts", "ktsP", "acsC", "canC", "frac")

INFO = c("clEnt", "nClEnt", "atrEnt", "nAtrEnt", "jEnt", "mutInf", "eqAtr", "noiSig")

MODEL = c("nodes", "leaves", "nodeAtr", "nodeIns", "leafCor", "lev_min", "lev_max", "lev_mean",
  "lev_sd", "bran_min", "bran_max", "bran_mean", "bran_sd", "att_min", "att_max", "att_mean",
  "att_sd")
